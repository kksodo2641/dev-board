...
- 미인증 API 요청에 빈 본문의 `401 Unauthorized` 응답 적용
...
세션 만료 시 댓글 변경 API 요청의 인증 실패 처리 관련 문서 최신화
...
- 프로젝트 완료 전 Architecture Decisions 전체 검토
  - 초기 ADR의 배경, 고려한 대안, 선택 이유 및 트레이드오프 보강
